...
<?php echo $__env->make('updown.user_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="<?php echo e(route('user.user_interface')); ?>">
              ...
              <div class="card info-card sales-card">
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6 id="form-count"><?php echo e($currentDateData); ?></h6>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card info-card weekly-card">
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6><?php echo e($currentWeekData); ?></h6>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card info-card revenue-card">
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6><?php echo e($currentMonthData); ?></h6>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="card info-card customers-card">
            <div class="card-body">
              ...
              <div class="d-flex align-items-center">
                ...
                <div class="ps-3">
                  <h6><?php echo e($currentYearData); ?></h6>
                </div>
              </div>
            </div>
          </div><!-- End Yearly Card -->
...
</html><?php /**PATH C:\Users\Kathrina Libres\CSM\resources\views/user/user_interface.blade.php ENDPATH**/ ?>
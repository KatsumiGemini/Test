...
<ul class="sidebar-nav" id="sidebar-nav">
  ...
  <li class="nav-item">
          ...
          <ul id="charts-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
            <li>
              <a href="<?php echo e(route('report.data1')); ?>" class="">
                <i class="bi bi-circle"></i><span>Per Office</span>
              </a>
            </li>
            <li>
              <a href="<?php echo e(route('report.data')); ?>" class="active">
        ...
        <tbody>
            <?php $__currentLoopData = $formData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $form): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td><?php echo e($form->office_user_name); ?></td> <!-- Display office user name -->
                    ...
                    <td><?php echo e($form->ccone); ?></td>
                    <td><?php echo e($form->cctwo); ?></td>
                    <td><?php echo e($form->ccthree); ?></td>
                    <td><?php echo e($form->suggest); ?></td>
...
</html><?php /**PATH C:\Users\Kathrina Libres\CSM\resources\views/report/data.blade.php ENDPATH**/ ?>
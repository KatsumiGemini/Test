        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="charts-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                    <li><a href="<?php echo e(route('report.data1')); ?>"><i class="bi bi-circle"></i><span>Main Campus</span></a></li>
                    <li><a href="<?php echo e(route('report.data')); ?>" class=""><i class="bi bi-circle"></i><span>Per Office</span></a></li>
                    <li><a href="<?php echo e(route('report.data2')); ?>"><i class="bi bi-circle"></i><span>University</span></a></li>
                </ul>
            </li>
            <li class="nav-item"><a class="nav-link collapsed" href="<?php echo e(route('report2')); ?>"><i class="bi bi-journal-text"></i><span>Report</span></a></li>
            <li class="nav-item"><a class="nav-link collapsed" href="<?php echo e(route('user.user_account')); ?>"><i class="bi bi-person"></i><span>User</span></a></li>
        </ul>
    </aside>
...
</html><?php /**PATH C:\Users\Kathrina Libres\CSM\resources\views/auth/profile.blade.php ENDPATH**/ ?>
...
@include('updown.headers')
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{ route('user.user_account') }}">
    ...
    <div class="col-lg-4">
      <div class="card">
        <div class="card-body">
          ...
          <form action="{{ route('registerUser') }}" method="post" id="user_form">
            @csrf
            <div class="mb-3">
...
$(function() {
    ...
    $(document).on('click', '#userupdate', function() {
        ...
        $.ajax({
            url: '{{ route("user_account") }}', // Ensure this route is defined
            method: 'post',
            data: updateData,
